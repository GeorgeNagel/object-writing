...
Ask clarifying questions **one at a time** and wait for the user's answer before asking the next. Do not proceed to Step 6 until all ambiguities are resolved.
...
Update the retro fields in the task markdown file.
